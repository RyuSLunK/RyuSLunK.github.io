	...
	.directive("main",function(){
	  return{
	    ...
	    controller: ['$scope', function($scope){
	      $scope.tab = 'about';
	      $scope.tabList = ["home","about","game","clock"];
